...
const val TOP_LEFT_COMPLICATION_TOP_BOUND = 84f / 384f
const val TOP_LEFT_COMPLICATION_RIGHT_BOUND = 33f / 384f + 72f / 384f
const val TOP_LEFT_COMPLICATION_BOTTOM_BOUND = 84f / 384f + 96f / 384f

const val BOTTOM_LEFT_COMPLICATION_LEFT_BOUND = 33f / 384f
const val BOTTOM_LEFT_COMPLICATION_TOP_BOUND = 204f / 384f
const val BOTTOM_LEFT_COMPLICATION_RIGHT_BOUND = 33f / 384f + 72f / 384f
const val BOTTOM_LEFT_COMPLICATION_BOTTOM_BOUND = 204f / 384f + 96f / 384f

const val TOP_RIGHT_COMPLICATION_LEFT_BOUND = 279f / 384f
const val TOP_RIGHT_COMPLICATION_TOP_BOUND = 84f / 384f
const val TOP_RIGHT_COMPLICATION_RIGHT_BOUND = 279f / 384f + 72f / 384f
const val TOP_RIGHT_COMPLICATION_BOTTOM_BOUND = 84f / 384f + 96f / 384f

const val BOTTOM_RIGHT_COMPLICATION_LEFT_BOUND = 279f / 384f
const val BOTTOM_RIGHT_COMPLICATION_TOP_BOUND = 204f / 384f
const val BOTTOM_RIGHT_COMPLICATION_RIGHT_BOUND = 279f / 384f + 72f / 384f
const val BOTTOM_RIGHT_COMPLICATION_BOTTOM_BOUND = 204f / 384f + 96f / 384f

const val LEFT_ICON_COMPLICATION_LEFT_BOUND = 33f / 384f
const val LEFT_ICON_COMPLICATION_TOP_BOUND = 126f / 384f
const val LEFT_ICON_COMPLICATION_RIGHT_BOUND = 33f / 384f + 54f / 384f
const val LEFT_ICON_COMPLICATION_BOTTOM_BOUND = 126f / 384f + 132f / 384f

const val RIGHT_ICON_COMPLICATION_LEFT_BOUND = 297f / 384f
const val RIGHT_ICON_COMPLICATION_TOP_BOUND = 126f / 384f
const val RIGHT_ICON_COMPLICATION_RIGHT_BOUND = 297f / 384f + 54f / 384f
